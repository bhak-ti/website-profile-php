    ...
    <body> 
      ...
      <section id="box-profile">
        <div class="img-profile">
            <div class="photo" style="background-image: url(assets/images/bart.jpg);"></div>
        </div>
      ...
      <section id="input-form">
        ...
        <div class="form">
          ...
          <div class="form">
            ...
            <input id="inpAvailability" type="text" name="availability" id="availability">
          </div>
          <div class="form">
              <label>Age</label>
              <input id="inpAge" type="number" name="age" id="age">
          </div>
          <div class="form">
            <label>Location</label>
            <input id="inpLocation" type="text" name="location" id="location">
          </div>
          <div class="form">
            <label>Years Experience</label>
            <input id="inpExperience" type="number" name="experience" id="experience">
          </div>
          <div class="form">
            <label>Email</label>
            <input id="inpEmail" type="email" name="email" id="email">
          </div>
          <div class="form">
            <input onclick="" class="bg-blue" type="submit" name="submit" id="submit">
          </div>          
        </form>
      </section>
      ...
      <script>
        ...
        function editForm(){
          ...
          var avail = document.getElementById("pAvailable").innerHTML;
